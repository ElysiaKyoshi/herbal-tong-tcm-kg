...
from __005__fastapi.__003__msg_queue import put_reply_content
...
async def generate_markdown_node(state: AgentState, config: RunnableConfig):
    ...
    history_messages.append({"role": "assistant", "content": markdown})
...
if __name__ == '__main__':
    print(generate_markdown_code("标题", "内容",
                                 [get_file_path("picture/20260724112013吃荔枝有什.png")]))