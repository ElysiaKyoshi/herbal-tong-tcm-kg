...
if __name__ == "__main__":
    ...
    #         images=[get_file_path("picture/20260724112013吃荔枝有什.png")],
    #         title="中医养生",
    #         content="中医养生hahha",
    #     )
    # )
    asyncio.run(xiaohongshu_auto_publish_node(
        state=AgentState(
            xiaohongshu_image_path_list=[get_file_path("picture/20260724112013吃荔枝有什.png")],
            xiaohongshu_tcm_post_title="中医养生",
            xiaohongshu_tcm_post_content="中医养生hahha"
        )))